        ...
        <div class="row mt-5">
            <div class="col-md-12">
                ...
                if (isset($_GET['filename']) && isset($_GET['modelfile']) && isset($_GET['scalerfile'])) {
                    ...
                    $hasil = shell_exec("python3 resulthasil.py " . escapeshellarg("../dataset/" . $filename) . " " . escapeshellarg("../model/" . $modelfile) . " " . escapeshellarg("../model/" . $scalerfile) . " 2>&1");
                    ...
                    echo "<div class='result-block'>No filename, model file, or scaler file provided.</div>";
                }
                ?>
            </div>
        </div>
