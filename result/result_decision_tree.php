...
<body>
    ...
    <div class="container mt-5">
        <h1 class="text-center">Decision Tree Results</h1>
        <div class="row mt-5">
            <div class="col-md-12">
                <h2>Classification Report</h2>
                <pre>
                    <?php
                    $report_file = '../hasil/classification_report_modeldecisiontree.csv';
            ...
            <div class="col-md-12">
                ...
                <img src="../hasil/confusion_matrix_modeldecisiontree.png" class="img-fluid" alt="Confusion Matrix">
            </div>
            <div class="col-md-12">
